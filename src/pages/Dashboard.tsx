  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow py-32 px-4">
        ...
        <span className="font-bold">conferem</span> um retorno aproximado de 15% no semestre (seis meses). Em caso de resgate antecipado, após o decurso do prazo mínimo de 30 dias, <span className="font-bold">contados a partir da data</span> de aplicação,{" "}
        <span className="font-bold">o pagamento</span> será efetuado em até 48 horas, <span className="font-bold">contadas</span> a partir da solicitação. O montante resgatado <span className="font-bold">será correspondente</span> ao principal aplicado, acrescido de juros equivalentes à taxa média da poupança{" "}
