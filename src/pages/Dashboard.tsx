              ...
              <Card className="glass-card overflow-hidden">
                ...
                dangerouslySetInnerHTML={{
                    __html: `
                        ...
                        <span class="font-bold">em vigência,</span> conforme estabelecido pelo Banco Central, 
                        <span class="font-bold">revisado</span> de forma proporcional ao tempo de investimento. Não há
