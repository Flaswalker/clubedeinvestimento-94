              ...
              <div className="glass-card rounded-2xl overflow-hidden w-full aspect-square md:aspect-video relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="p-8 text-center">
                    ...
                    <p className="text-muted-foreground"><span className="font-bold">Potencialize</span> seus investimentos com uma estratégia que busca rentabilidade consistente, com projeções de até 2,5% ao mês e retorno aproximado de 15% no semestre, desde que mantenha seus ativos aplicados no período. Comece com apenas R$ 100,00 e transforme seus objetivos financeiros em realidade. Entre em contato pelo WhatsApp: (75) 99801-2820.</p>
                  </div>
                </div>
              </div>
            </div>
