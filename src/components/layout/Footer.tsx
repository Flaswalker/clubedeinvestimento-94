...
const Footer = () => {
  ...
  return (
    <footer className="glass-panel mt-20 pt-16 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-8 h-8 rounded-full bg-secondary flex items-center justify-center transition hover:bg-primary/20"
                aria-label="Facebook"
              >
                <Facebook size={16} />
              </a>
